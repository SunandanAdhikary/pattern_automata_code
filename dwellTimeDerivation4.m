...
%%%%%%%%%%%%
    ...
    % max_zero_cls_i(i) = max(abs(zero(closed_loops{i})));
...
figure("Name","zero changes");
subplot(3,1,1);
plot(max_zero_mr_ol);
title('open loops multi rate');
subplot(3,1,2);
% plot(max_zero_mr_cl);
% title('closed loops multirate');
subplot(3,1,3);
plot(max_zero_cltfs_d);
title('closed loops delayed no multirate');
% ---
figure("Name","pole changes ");
subplot(4,1,1);
plot(max_eig_mr_ol);
title('open loop poles multi rate');
subplot(4,1,2);
plot(max_eig_mr_cl);
title('closed loop poles multi rate');
subplot(4,1,3);
plot(max_eig_d);
title('closed loops delyed no multi rate');
subplot(4,1,4);
plot(max_eig_i);
title('closed loops dropped no multirate');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% p=1;q=1;
